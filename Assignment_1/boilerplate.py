...
train_data_dir = '/train/path/here' # put path of training dataset
val_data_dir = '/val/path/here' # put path of validation dataset
test_data_dir = '/test/path/here' # put path of test dataset
