...
class Net(nn.Module):
    def __init__(self):
        ...
        self.conv1 = nn.Conv2d(in_channels=3, out_channels=64, kernel_size=2, stride=4)
        self.pool = nn.MaxPool2d(kernel_size=2, stride=2)
        self.conv2 = nn.Conv2d(in_channels=64, out_channels=128, kernel_size=2, stride=4)
        self.conv3 = nn.Conv2d(in_channels=128, out_channels=256, kernel_size=2, stride=4)
